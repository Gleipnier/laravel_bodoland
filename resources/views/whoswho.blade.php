...
@section('content')
    ...
    <section class="sep_blk_t bread-crumb">
        <div class="container">
            <h1 class="fz42 text-center fw800">Who Is Who</h1>
        </div>
    </section>
                                    ...
                                    <div class="director-info align-items-center green-bg d-md-flex position-relative">
                                        ...
                                        <div>
                                            <h3 class="fz24 fw700 mb-4"><a href="#">{{ $whoIsWho->name }}</a>
                                                <span class="d-block fz16 fw400"><i
                                                        class="my-3 d-block">{{ $whoIsWho->designation }} </i> </span>
                                            </h3>
                                            <p class="tx01"><a href="mailto:%20director@iitkgp.ac.in"></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
