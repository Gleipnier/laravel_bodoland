...
@section('content')
    ...
    <div class="container-membership" style="padding-top: 70px">
        <div class="content">
            ...
            <p>Be a part of our community and help us serve the needs of our users. Your contribution helps us continue
                serving the community through education, resources, and services. Discover ways you can support us below.
            </p>
    ...
    <section class="volunteer-section">
        <div class="volunteer-content">
            ...
            <p>Help the helpless during your holidays for a better world. We believe that every child deserves a childhood
                filled with hope, joy, and the opportunity to pursue their dreams and career.</p>
    ...
    <section class="support-section">
        <div class="container-supp">
            <div class="support-header">
                ...
                <p>Your contribution helps us continue serving the community through education, resources, and services.
                    Discover ways you can support us below.</p>
            </div>

            <!-- Donations & Support Section -->
            <div class="support-content">
                <h2>Donations & Support</h2>
                <p>We accept donations of books, resources, and funds to help expand our collections and services. Your
                    generous contribution enables us to keep improving the library for the benefit of all community members.
                </p>
                <ul>
                ...
                <p>If you’re interested in donating, please reach out to us through the contact information provided below.
                </p>
            ...
            <div class="support-content">
                ...
                <p>Looking to give back to your community? Volunteering with us is a great way to help promote education and
                    literacy. We offer a range of volunteer opportunities:</p>
                <ul>
                ...
                <p>If you're interested in becoming a volunteer, contact us, and we’ll provide more details about how you
                    can get involved.</p>
            </div>
