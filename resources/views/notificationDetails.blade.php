        ...
        <div class="container">
            ...
            <div class="row evntrow iitgx-4" id="dataList">
                ...
                <div class="col-md-6">
                    <div class="bx">
                        <div class="row">
                            <div class="col-lg-4"><img style="height:200px;" src="{{ asset('/images/event-default.jpg') }}"
                                    class="round04" alt="AI-ML and IoT">
                            </div>
                            <div class="col-lg-8">
                                <div class="con_bk">
                                    ...
                                    <p>
                                        ...
                                        <a href="{{ route('notificationView', ['id' => $notification->id]) }}"
                                            class="btn btn-primary">View Notification</a>
                                    </p>
                                </div>
                            </div>
                        </div>
